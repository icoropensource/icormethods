...
def Main():
   DEFAULT_PROCESS_EXECUTOR='"'+icorapi.GetVariable(0,'_DEFAULT_PYTHON_TOP_DIR')+'/External/default/main.py'+'"' #
   PPID=str(os.getpid())
...
#         saveerr=SysOutWrapper(0)
         print 'Start Daemon [toid=%d, pid=%s]'%(toid,PPID)
   ...
   #         print time.ctime(time.time())
            ...
            while poid>=0:
               if icorapi.ObjectExists(0,pcid,poid)>=0:
