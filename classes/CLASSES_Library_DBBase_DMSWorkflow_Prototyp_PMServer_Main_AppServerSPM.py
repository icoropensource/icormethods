...
class MassPaymentsServer:
   ...
   def SendMail(self,asubject,atext):
      ...
      asmtp.quit()       
   def GetRandomFileNameOld(self,aaplikacja,aprefix):
      adir=self.Aplikacje2SciezkaDanych[(aaplikacja,self.RokObliczeniowy)]
   ...
   def GetRandomFileName(self,aaplikacja,aprefix):
      ...
      while not adir and acnt<10:
         ...
         acnt=acnt+1
      if not adir:
         print self.Aplikacje2SciezkaDanych.keys()
...
#                     aRachunekDocelowy=acsv['RachunekDocelowy']
                     ...
                     rs.Fields.Item('Kontrahent').Value=acsv['Nadawca1']+acsv['Nadawca2']
