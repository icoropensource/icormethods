...
<BUTTON onclick="doSubmit();">Importuj nowe adresy</BUTTON>
""")
   return
...
def DoGenerateSubmit(amenu,areport,file):
   ...
   astate=ICORSync.ICORState(aname='SOK_AKTUALIZACJA_GEO2',avalue='RUN')
   aclass.DoUruchomAktualizacjeAdresow2(str(astate.OID),-1,'')
   file.write("""
