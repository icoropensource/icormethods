...
from CLASSES_Library_DBBase_Query_MultiDimension_XML_Preprocessor_DoGenerate import *
...
def OnWWWAction(aobj,amenu,file):
   ...
   if amenu.Action=='ObjectApplyMethods':
      aobj.Class.Queries.DeleteReferencedObjects(aobj.OID)
      ...
      if 1:
         ...
         aparser.Parse(aobj.Class,aobj.OID)
      file.write('<h1>Utworzono definicje zestawień</h1>')
#      awwweditor.Write()
