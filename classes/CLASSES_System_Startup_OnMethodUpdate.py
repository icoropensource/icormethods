...
def ICORMain(CID=-1, FieldName='', OID=-1, Value='', UID=-1):
   return
   import string
#   print 'U: MethodCID:        ',aICORDBEngine.Variables._MethodCID
#   print 'U: MethodName:       ',aICORDBEngine.Variables._MethodName
#   print 'U: MethodOwnerCID:   ',aICORDBEngine.Variables._MethodOwnerCID
#   print 'U: MethodAllowUpdate:',aICORDBEngine.Variables._AllowMethodUpdate
   ...
   if aoid>=0:
      ...
      arefs=aclass.AllowUpdateGroups.GetRefList(aoid)
      w=1
      while arefs.position>=0:
         ...
         arefs.Next()
      if w==0:
         print 'Method update: Access denied -',mname
         aICORDBEngine.Variables._AllowMethodUpdate='0'
   return
