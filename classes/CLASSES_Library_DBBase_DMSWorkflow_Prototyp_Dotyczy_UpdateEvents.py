...
def ICORMain(CID=-1, FieldName='', OID=-1, Value='', UID=-1):
   ...
   efieldname='TableEvents'
   lfields=[
'ASPClientBeforeSubmit',
'ASPSourceAfterCommit',
'ASPSourceOnAfterFieldsSheetShowOneTable',
'ASPSourceOnAfterSheetShowOneTable',
'ASPSourceOnAfterShowOneTable',
'ASPSourceOnBeforeFieldsSheetShowOneTable',
'ASPSourceOnBeforeSheetShowOneTable',
'ASPSourceOnBeforeShowOne',
'ASPSourceOnBeforeShowOneTable',
'ASPSourceOnDelete',
'ASPSourcePreSubmitCheck',
'ASPSourceShowAfter',
'ASPSourceShowBefore',
'ASPSourceShowFields',
'ASPSourceShowFieldsAfter',
'ASPSourceShowFieldsBefore',
'ASPSourceShowFieldsStart',
'ASPSourceSubmit',
]
